...
window.onload = function() {
	...
	// 初始使用普通立方体
	cubenumPoints = useBumpyCube ? bumpyCube(1.0, 10) : colorCube(1.0);
...
// 切换凹凸效果函数
function toggleBumpyEffect() {
	useBumpyCube = !useBumpyCube;
	console.log("凹凸效果: " + (useBumpyCube ? "开启" : "关闭"));
